...
public class Person extends java.util.Vector<String>{
	...
	static final Comparator<Person> nameOrder = new Comparator<Person>(){
	...
	static final Comparator<Person> numOrder = new Comparator<Person>(){
		public int compare(Person a,Person b){
			int char_num;
	...
	static final Comparator<Person> dateOrder = new Comparator<Person>(){
		public int compare(Person a,Person b){
	...
	static final Comparator<Person> expireOrder = new Comparator<Person>(){
		public int compare(Person a,Person b){
